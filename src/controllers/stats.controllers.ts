...
export const getTop5Buyers = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    const topBuyersStats = await statsService.findTop5Buyers(req, res, next);
